        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/iedcgecpkd/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-pink-600/80 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110"
              ...
              {/* LinkedIn */}
              <a 
                href="https://www.linkedin.com/company/iedc-gec-pkd/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-blue-600/80 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* Email */}
              <a 
                href="mailto:iedc@gecpkd.ac.in" 
                className="w-10 h-10 bg-white/10 hover:bg-amber-600/80 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110"
                aria-label="Email"
              >
